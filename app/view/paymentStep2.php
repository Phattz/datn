    ...
    // TÍNH TỔNG + VOUCHER + PHÍ SHIP
    $totalProducts = 0;
    if (isset($_SESSION['cart'])) {
        foreach ($_SESSION['cart'] as $itemCalc) {
            $totalProducts += ($itemCalc['price'] * $itemCalc['quantity']);
        }
    }
    $shippingFee = $_SESSION['voucher']['shippingFee'] ?? 30000;
    $voucherDiscount = $_SESSION['voucher']['discount'] ?? 0;
    $grandTotal = $totalProducts + $shippingFee - $voucherDiscount;
...
<?php } ?>
                        ...
                        <div class="payment__infomation-summary">
                            <div class="summary-item">
                                <span>Sản phẩm</span>
                                <span><?= number_format($totalProducts) ?> đ</span>
                            </div>
                            <div class="summary-item">
