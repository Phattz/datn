                        ...
                        <td>
                            <?php if ($order['orderStatus'] == 3 && empty($item['ratingStar'])): ?>
                                ...
                                <?php elseif ($order['orderStatus'] == 3): ?>
                                    <div class="rated-box">
                                        <div class="rated-label">
                                            Đã đánh giá: <?= $item['ratingStar'] ?> ★
                                        </div>

                                        <?php if (!empty($item['reviewContent'])): ?>
                                            <div class="review-content"
                                                title="<?= htmlspecialchars($item['reviewContent']) ?>">
                                                “<?= htmlspecialchars($item['reviewContent']) ?>”
                                            </div>
                                        <?php endif; ?>
                                    </div>
        ...
        <div class="order-right">
            ...
            <?php if ($order['orderStatus'] == 1): ?>
                <form method="post" action="index.php?page=cancelTrackOrder">
                    <input type="hidden" name="source" value="track">
